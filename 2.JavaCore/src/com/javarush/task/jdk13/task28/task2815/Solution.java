...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        ExecutorService executorServiceWorkStealing = Executors.newWorkStealingPool(4);

        runProcess(executorServiceSingle);
        runProcess(executorServiceFixed);
        runProcess(executorServiceWorkStealing);
